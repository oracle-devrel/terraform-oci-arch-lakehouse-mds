...
module "oss-data-analytics" {
  ...
  availability_domain_name  = var.availability_domain_name == "" ? data.oci_identity_availability_domains.ADs.availability_domains[0]["name"] : var.availability_domain_name
  ...
  analytics_subnet_id       = oci_core_subnet.analytics_subnet.id
