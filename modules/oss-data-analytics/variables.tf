...
variable "analytics_subnet_id" {
  description = "The OCID of the analytics subnet to create the VNIC for public/private access. "
  default     = ""
}
...
variable "shared_working_dir" {
  description = "Decide where to store analytics data"
  default     = "/shareddir"
}
...
variable "defined_tags" {
  description = "Defined tags for the host."
  type        = map(string)
  default     = {}
}
